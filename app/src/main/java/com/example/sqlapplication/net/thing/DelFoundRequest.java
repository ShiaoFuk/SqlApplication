...
public class DelFoundRequest {
    private final static String TAG = DelFoundRequest.class.getName();

    public static void get(RequestListener listener, MyRequestBody<Integer> requestBody) {
        listener.onRequest();
    ...
    private static JsonElement request(MyRequestBody<Integer> requestBody) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("http://suansun.top/thing/found/delete")
                .method("POST", body)
