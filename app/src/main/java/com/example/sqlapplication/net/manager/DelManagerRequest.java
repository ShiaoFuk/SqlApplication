...
public class DelManagerRequest {
    private final static String TAG = DelManagerRequest.class.getName();

    public static void del(RequestListener listener, MyRequestBody<Integer> requestBody) {
        listener.onRequest();
    ...
    private static JsonElement request(MyRequestBody<Integer> requestBody) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("http://suansun.top/manager/delete")
                .method("POST", body)
