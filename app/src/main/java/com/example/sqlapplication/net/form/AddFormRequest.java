...
public class AddFormRequest {
    private final static String TAG = AddFormRequest.class.getName();

    public static void add(RequestListener listener, MyRequestBody<Integer> requestBody) {
        listener.onRequest();
    ...
    private static JsonElement request(MyRequestBody<Integer> requestBody) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("http://suansun.top/form/post")
                .method("POST", body)
